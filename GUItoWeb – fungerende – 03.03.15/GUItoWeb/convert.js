...
function latlongToUTM1() {
    ...
    window.fromplacex = window.xkord; //array
    window.fromplacey = window.ykord; //array
    window.toplacex = xkoordinat;
    window.toplacey = ykoordinat;

    // console.log(fromplace, toplace, fromplace1, toplace1);

    window.urlferdig = 'https://www.vegvesen.no/ruteplan/routingservice_v1_0/routingservice/solve?&stops=' + fromplacex + "," + fromplacey + ";" + toplacex + "," + toplacey + '&barriers&format=json';
